...
public class TaikoPerformanceAttributes @PublishedApi internal constructor(override val ptr: NativePointer) :
    ...
    override val difficulty: TaikoDifficultyAttributes get() = TaikoDifficultyAttributes(ptr = getDifficulty(ptr = ptr))
